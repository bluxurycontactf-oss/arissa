import { Brain, Infinity as InfinityIcon, Workflow, TrendingUp, Bot, Activity } from "lucide-react";
...
export default function DigitalTwin() {
  return (
    <section id="fonctionnalites" className="py-24 sm:py-32 border-t border-border-soft relative overflow-hidden">
